package com.bidemajnoon.eslahi.fehrest.changali
...
class Changali : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        img.setImageResource(R.drawable.changali)

        txt = findViewById(R.id.textView)
        txt.setText(R.string.areze_changali)
