...
class PayeParantezi : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        img.setImageResource(R.drawable.paye_parantezi)//it must to change

        txt = findViewById(R.id.textView)
        txt.setText(R.string.areze_paye_parantezi)//it must to change
